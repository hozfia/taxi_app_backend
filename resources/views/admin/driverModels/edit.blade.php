        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.driverModel.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.driver-models.update", [$driverModel->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group {{ $errors->has('driver_location') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="driver_location" name="driver_location" class="form-control" value="{{ old('driver_location', isset($driverModel) ? $driverModel->driver_location : '') }}" required>
